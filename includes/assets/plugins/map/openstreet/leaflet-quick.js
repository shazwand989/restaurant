$(document).ready(function () {
    if (document.getElementById("map") !== null) {
        ...
        var locations = [[locationData('single-job-page.html', 'images/company-logo-01.html', "Hexagon", 'Bilingual Event Support Specialist', 'verified'), 37.788181, -122.461270, 5, '']];
