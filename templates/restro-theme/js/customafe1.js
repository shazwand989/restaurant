    ...
    $(document).ready(function () {
        ...
        $('.billing-cycle-radios').on("click", function () {
            if ($('.billed-yearly-radio input').is(':checked')) {
                ...
                $('.pricing-plans-container .pricing-plan').show();
                $('.pricing-plans-container .trial-plan').show();
                $('.pricing-plans-container .lifetime-plan').hide();
            }
            ...
            if ($('.billed-lifetime-radio input').is(':checked')) {
                ...
                $('.pricing-plans-container .pricing-plan').hide();
                $('.pricing-plans-container .lifetime-plan').show();
                $('.pricing-plans-container .trial-plan').show();
            }
        });
