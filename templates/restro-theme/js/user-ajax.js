jQuery(function ($) {
    ...
    $("#login-form").on('submit',function (e) {
        ...
        var form_data = {
            ...
            is_staff: $("#is_staff").is(":checked") ? 1 : 0,
            is_ajax: 1
        };
    ...
    var audiomp3 = new Audio(siteurl+'includes/assets/audio/new-order.mp3');
    ...
    function manage_orders(response)
    {
        if(!jQuery.isEmptyObject( response )){
            ...
            if(localStorage.notification_sound == 1) {
                audiomp3.play();
                alertify.success('You have a new order with ID #' + localStorage.latestOrderId + '.');
                //audioogg.play();
            }
